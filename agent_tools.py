                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            ...
                            "template": {
                                "type": "string",
                                "enum": list(FIGURE_TEMPLATES),
                                "description": "Semantic contest-paper preset; it changes layout and renders claim-specific layers.",
                            },
                            "figure_intent": {
                                "type": "object",
                                "properties": {
                                    ...
                                    "strict": {"type": "boolean"},
                                    "numerical_tolerance": {"type": "number", "minimum": 0},
                                },
                                "additionalProperties": False,
                            },
                            "event_times": {"type": "array", "items": {"type": "number"}},
                            "threshold": {"type": "number"},
                            "threshold_label": {"type": "string"},
                            "optimum": {
                                "type": "object",
                            ...
                            "summarize_intervals": {"type": "boolean"},
                            "x_scale": {"type": "string", "enum": ["linear", "log", "symlog"]},
                            "y_scale": {"type": "string", "enum": ["linear", "log", "symlog"]},
                            "direct_labels": {"type": "boolean"},
                            "equal_aspect": {"type": "boolean"},
                            "layers": {"type": "array", "items": {"type": "string"}},
                            "geometry_layers": {"type": "array", "items": {"type": "object"}},
